...
// bartender.proto
exports.bartender = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'bartender.desc')));
...
exports.playlist4service = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4service.desc')));
