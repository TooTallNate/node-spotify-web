...
Spotify.prototype.playlist = function (uri, from, length, fn) {
  ...
  var playlist = new Playlist(this, uri);
...
Spotify.prototype._recursePlaylist = function(playlistUri, searchUri, fn) {
  ...
  // TODO: remove/simplify code - no longer used by playlist code - only by rootlist
...
Spotify.prototype.createPlaylist = function(attrs, fn) {
  ...
  this.sendProtobufRequest(args, function(err, res) {
    ...
    var revision = util.revision2string(res.revision);
    var playlist = new Playlist(self, playlistUri, revision);
