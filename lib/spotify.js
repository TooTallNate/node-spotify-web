...
Spotify.prototype.starred = function (user, from, length, fn) {
  ...
  var starred = new this.Playlist('spotify:user:' + user + ':starred');
...
Spotify.prototype.rootlist = function (user, from, length, fn) {
  ...
  var rootlistName = (user == this.username) ? 'rootlist' : 'publishedrootlist';
  var rootlist = new this.Playlist('spotify:user:' + user + ':' + rootlistName);
