...
function Spotify () {
  ...
  // binded callback for when user doesn't pass a calclback function
...
Spotify.prototype._onsecret = function (err, res) {
  ...
  creds.type = 'sp';
  creds.secret = secret;
  creds.trackingId = "f055b1288b248507179d07337de7a678b07a1687";
  creds.cf = "";
  creds.f = "contextual";
  creds.s = "direct";
...
Spotify.prototype.sendProtobufRequest = function(req, fn) {
  ...
  var loadSchema = function(schema, dontRecurse) {
    if ('string' === typeof schema) {
      ...
      var schema = schemas.build(schemaName[0], schemaName[1]);
      if (!schema)
