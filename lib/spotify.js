...
// mercury.proto
var mercury = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'mercury.desc')));
...
// metadata.proto
var metadata = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'metadata.desc')));
...
// playlist4meta.proto
var playlist4meta = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4meta.desc')));

// playlist4issues.proto
var playlist4issues = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4issues.desc')));

// playlist4opts.proto
var playlist4ops = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4ops.desc')));

// playlist4content.proto
var playlist4content = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4content.desc')));

// playlist4changes.proto
var playlist4changes = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'playlist4changes.desc')));
var ListDump = playlist4changes['spotify.playlist4.proto.ListDump'];

// toplist.proto
var toplist = new protobuf.Schema(fs.readFileSync(path.resolve(proto, 'toplist.desc')));
...
Spotify.prototype.playlist = function (uri, from, length, fn) {
  ...
  this.sendCommand('sp/hm_b64', args, function (res) {
    console.log(res);
    var obj = ListDump.parse(new Buffer(res.result[1], 'base64'));
    console.log(obj);
  });
};
...
Spotify.prototype.sendTrackEnd = function (lid, uri, ms, fn) {
  ...
  this.sendCommand('sp/track_end', args, function (res) {
    if (!res.result) {
...
Spotify.prototype.sendTrackEvent = function (lid, event, ms, fn) {
  ...
  var num = event;
  var args = [ lid, num, ms ];
  this.sendCommand('sp/track_event', args, function (res) {
    console.log(res);
  });
};
...
Spotify.prototype.sendTrackProgress = function (lid, ms, fn) {
  ...
  this.sendCommand('sp/track_progress', args, function (res) {
    console.log(res);
  });
};
