...
function Spotify () {
  ...
  // wrap object classes
  this.Playlist = this._wrap(Playlist);
}
 ...
 *
 * This method is provided for legacy api compatibility and as a helper function.
 * See also the spotify.Playlist object class which is much more powerful.
 *
...
Spotify.prototype.playlist = function (uri, from, length, fn) {
  ...
  var playlist = new this.Playlist(uri);
...
/**
 * Wraps an object class
 * The constructor and each static method is prepended with 
 *
 * @api private
 */

Spotify.prototype._wrap = function(obj) {
  var spotify = this;
  ...
  var wrapfn = function() {
    ...
    argArray.unshift(spotify);
    return obj.apply(newObj, argArray) || newObj;
  };

  // share prototype so instanceof works
  wrapfn.prototype = obj.prototype;

  // wrap static methods and attributes
  Object.keys(obj).forEach(function(key){
    var val = obj[key];
    var wrap = val;
    if ('function' == typeof val) {
      wrap = function wrapfn() {
        var argArray = Array.prototype.slice.call(arguments, 0); 
        argArray.unshift(spotify);
        return val.apply(null, argArray);
      };
    }
    Object.defineProperty(wrapfn, key, {
      value: wrap,
      enumerable: true,
      writable: false,
      configurable: true
