 ...
 * Spotify URL -> URI
 * i.e.
 * >>>SpotifyUtil.link2uri('https://open.spotify.com/user/christophior/playlist/5WPqoqEsWKA0n2EDVu5aJ3')
 * 'spotify:user:christophior:playlist:5WPqoqEsWKA0n2EDVu5aJ3'
 */

exports.url2uri = function (url) {
  var url = url.replace(/https:\/\/open.spotify.com/g, 'spotify');
