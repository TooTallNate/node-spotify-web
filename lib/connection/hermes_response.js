...
var debug = require('debug')('spotify-web:response:hermes');
...
HermesResponse.prototype.parse = function(data) {
  ...
  // general case
    ...
    var header = MercuryRequest.parse(new Buffer(data.result[0], 'base64'));
    ...
    if (data.result.length > 1)
      this.result = new Buffer(data.result[1], 'base64');
  }  

  if (this.result && this.request.responseSchema)
