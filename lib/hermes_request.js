...
var debug = require('debug')('spotify-web:request:hermes');
 ...
 *
 * @param {Spotify} spotify The spotify instance
 * @param {String} (Optional) method The request method
 * @param {Object|String} args The request arguments, or the Hermes URI
 */

function HermesRequest(spotify, method, args) {
  Request.call(this, spotify, hermesRequestName, null);
